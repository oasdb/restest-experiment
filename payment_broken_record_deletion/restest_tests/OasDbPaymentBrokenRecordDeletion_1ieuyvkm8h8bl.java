...
public class OasDbPaymentBrokenRecordDeletion_1ieuyvkm8h8bl {
	...
	private static final String testId = "1ieuyvkm8h8bl";
	...
	@Test
	public void test_rhrnwz3ae1q0_createcharge() {
		String testResultId = "test_rhrnwz3ae1q0_createcharge";
	...
	@Test
	public void test_1iexqngg9zuwp_createcharge() {
		String testResultId = "test_1iexqngg9zuwp_createcharge";
		...
		try {
			...
			.given()
				.log().all()
				.contentType("application/json")
				.body("{\"amount\":-1,\"credit_card_id\":-9223372036854775808}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_t8f78t8bn7zt_createcharge() {
		String testResultId = "test_t8f78t8bn7zt_createcharge";
	...
	@Test
	public void test_1ib0gy85yewc4_createcharge() {
		String testResultId = "test_1ib0gy85yewc4_createcharge";
	...
	@Test
	public void test_s50ni87y24vq_readcharge() {
		String testResultId = "test_s50ni87y24vq_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", ":FZuEY&Lae4(nm}%")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_rlb73vh9utyp_readcharge() {
		String testResultId = "test_rlb73vh9utyp_readcharge";
	...
	@Test
	public void test_rhg23umnh54k_readcharge() {
		String testResultId = "test_rhg23umnh54k_readcharge";
	...
	@Test
	public void test_rl54u8tkttmg_readcharge() {
		String testResultId = "test_rl54u8tkttmg_readcharge";
	...
	@Test
	public void test_1jyjbtr6v1b8z_updatecharge() {
		String testResultId = "test_1jyjbtr6v1b8z_updatecharge";
	...
	@Test
	public void test_1iv726b26bfw0_updatecharge() {
		String testResultId = "test_1iv726b26bfw0_updatecharge";
	...
	@Test
	public void test_1ib0dtzadwjzs_updatecharge() {
		String testResultId = "test_1ib0dtzadwjzs_updatecharge";
	...
	@Test
	public void test_toihasop5fzo_updatecharge() {
		String testResultId = "test_toihasop5fzo_updatecharge";
		...
		try {
			...
			.given()
				...
				.pathParam("charge_id", "-2147483648")
				.contentType("application/json")
				.body("{\"amount\":\"\\\\0\",\"credit_card_id\":4294967296,\"currency\":null}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_t4telvn9ykx2_deletecharge() {
		String testResultId = "test_t4telvn9ykx2_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "B `!tZp$ZNcN+dRc_@nY")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_somyfi0z244i_deletecharge() {
		String testResultId = "test_somyfi0z244i_deletecharge";
	...
	@Test
	public void test_u7ukoyr6fgvl_deletecharge() {
		String testResultId = "test_u7ukoyr6fgvl_deletecharge";
	...
	@Test
	public void test_rhrnwv308xtl_deletecharge() {
		String testResultId = "test_rhrnwv308xtl_deletecharge";
