...
public class OasDbPaymentBrokenRecordDeletion_u8552qyfi1px {
	...
	private static final String testId = "u8552qyfi1px";
	...
	@Test
	public void test_1iauvucfjelic_createcharge() {
		String testResultId = "test_1iauvucfjelic_createcharge";
		...
		try {
			...
			.given()
				...
				.body("{\"amount\":2147483648,\"credit_card_id\":-1,\"currency\":\"\"}")
				.filter(allureFilter)
	...
	@Test
	public void test_t4f1f2exrint_createcharge() {
		String testResultId = "test_t4f1f2exrint_createcharge";
	...
	@Test
	public void test_rhajsv0h6fl1_createcharge() {
		String testResultId = "test_rhajsv0h6fl1_createcharge";
		...
		try {
			...
			.given()
				.log().all()
				.contentType("application/json")
				.body("{\"amount\":-2147483648,\"credit_card_id\":2147483648}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_qxyvzza4iqt0_createcharge() {
		String testResultId = "test_qxyvzza4iqt0_createcharge";
	...
	@Test
	public void test_1iuvhjfw1652o_readcharge() {
		String testResultId = "test_1iuvhjfw1652o_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "7vNF2]&[luNuUF?")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1h85bhcipgrhy_readcharge() {
		String testResultId = "test_1h85bhcipgrhy_readcharge";
	...
	@Test
	public void test_1iupz5jaagyt1_readcharge() {
		String testResultId = "test_1iupz5jaagyt1_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "oWFPZpZIm)'shI}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1hrs1lr9ch2ee_readcharge() {
		String testResultId = "test_1hrs1lr9ch2ee_readcharge";
	...
	@Test
	public void test_1ibhka050ak4l_updatecharge() {
		String testResultId = "test_1ibhka050ak4l_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "TVy:CJoeT)cb'xl_%$G")
				.contentType("application/json")
				.body("{\"currency\":\"\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
	...
	@Test
	public void test_skv3j2y37z37_updatecharge() {
		String testResultId = "test_skv3j2y37z37_updatecharge";
		...
		try {
			...
			.given()
				...
				.contentType("application/json")
				.body("{\"amount\":null,\"credit_card_id\":2147483648,\"currency\":\"@)V[Jy'q:pa;\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1jylkw84vexip_updatecharge() {
		String testResultId = "test_1jylkw84vexip_updatecharge";
	...
	@Test
	public void test_1iv6jv2hq5rae_updatecharge() {
		String testResultId = "test_1iv6jv2hq5rae_updatecharge";
	...
	@Test
	public void test_t8f7n65wqcs8_deletecharge() {
		String testResultId = "test_t8f7n65wqcs8_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "o$\\f4DqqbarEdS|}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1k254ei8jj812_deletecharge() {
		String testResultId = "test_1k254ei8jj812_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "y_KrTn;\"rQbkJ")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_rkwryglh3lnm_deletecharge() {
		String testResultId = "test_rkwryglh3lnm_deletecharge";
	...
	@Test
	public void test_to1uq4fwj9sz_deletecharge() {
		String testResultId = "test_to1uq4fwj9sz_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "H6]$-kk&@aibL-OEa")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
