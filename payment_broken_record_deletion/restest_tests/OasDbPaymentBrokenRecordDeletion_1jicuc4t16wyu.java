...
public class OasDbPaymentBrokenRecordDeletion_1jicuc4t16wyu {
	...
	private static final String testId = "1jicuc4t16wyu";
	...
	@Test
	public void test_1jecohvw7ob3n_createcharge() {
		String testResultId = "test_1jecohvw7ob3n_createcharge";
		...
		try {
			...
			.given()
				...
				.body("{\"amount\":4294967296,\"currency\":\"\"}")
				.filter(allureFilter)
	...
	@Test
	public void test_t86wb8tyl2r4_createcharge() {
		String testResultId = "test_t86wb8tyl2r4_createcharge";
	...
	@Test
	public void test_trqu9wxxjrjk_createcharge() {
		String testResultId = "test_trqu9wxxjrjk_createcharge";
	...
	@Test
	public void test_vbsje3cdorxd_createcharge() {
		String testResultId = "test_vbsje3cdorxd_createcharge";
	...
	@Test
	public void test_1iaxlz6wl0jll_readcharge() {
		String testResultId = "test_1iaxlz6wl0jll_readcharge";
	...
	@Test
	public void test_urhb7ekm2zhv_readcharge() {
		String testResultId = "test_urhb7ekm2zhv_readcharge";
	...
	@Test
	public void test_1hrmj87a19pib_readcharge() {
		String testResultId = "test_1hrmj87a19pib_readcharge";
	...
	@Test
	public void test_1iberq04nugqa_readcharge() {
		String testResultId = "test_1iberq04nugqa_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "CL@jNzvB*g}Dsj")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_ubj5htmzqq1y_updatecharge() {
		String testResultId = "test_ubj5htmzqq1y_updatecharge";
	...
	@Test
	public void test_uvenphc51r92_updatecharge() {
		String testResultId = "test_uvenphc51r92_updatecharge";
		...
		try {
			...
			.given()
				...
				.contentType("application/json")
				.body("{\"amount\":-1,\"credit_card_id\":2147483648,\"currency\":\"\\\\0\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_qhhqm0ue3skm_updatecharge() {
		String testResultId = "test_qhhqm0ue3skm_updatecharge";
		...
		try {
			...
			.given()
				...
				.contentType("application/json")
				.body("{\"credit_card_id\":1.100000023841858,\"currency\":\"O{uu`j63Ee8@m\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_s0uj8swvt0dz_updatecharge() {
		String testResultId = "test_s0uj8swvt0dz_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", ":R9.nA'aDdpVUPLpL\"")
				.contentType("application/json")
	...
	@Test
	public void test_1jew0z4xhu0qb_deletecharge() {
		String testResultId = "test_1jew0z4xhu0qb_deletecharge";
	...
	@Test
	public void test_qxob4zje4in9_deletecharge() {
		String testResultId = "test_qxob4zje4in9_deletecharge";
	...
	@Test
	public void test_vf9p5dmznxgw_deletecharge() {
		String testResultId = "test_vf9p5dmznxgw_deletecharge";
	...
	@Test
	public void test_skvm65cs4m05_deletecharge() {
		String testResultId = "test_skvm65cs4m05_deletecharge";
