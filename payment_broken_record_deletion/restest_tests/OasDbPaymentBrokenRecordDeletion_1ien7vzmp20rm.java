...
public class OasDbPaymentBrokenRecordDeletion_1ien7vzmp20rm {
	...
	private static final String testId = "1ien7vzmp20rm";
	...
	@Test
	public void test_ts1x1zi83cq8_createcharge() {
		String testResultId = "test_ts1x1zi83cq8_createcharge";
		...
		try {
			...
			.given()
				...
				.body("{\"amount\":2147483648,\"credit_card_id\":1.100000023841858,\"currency\":null}")
				.filter(allureFilter)
	...
	@Test
	public void test_1hrriwgd4zm92_createcharge() {
		String testResultId = "test_1hrriwgd4zm92_createcharge";
	...
	@Test
	public void test_uve6k4jyhfe8_createcharge() {
		String testResultId = "test_uve6k4jyhfe8_createcharge";
		...
		try {
			...
			.given()
				.log().all()
				.contentType("application/json")
				.body("{\"amount\":\"hu7vK.~t8OZ@lY\",\"credit_card_id\":-9223372036854775808}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1hbisf60vanvm_createcharge() {
		String testResultId = "test_1hbisf60vanvm_createcharge";
		...
		try {
			...
			.given()
				.log().all()
				.contentType("application/json")
				.body("{\"amount\":\"5y@bn2yFu7v6?V\",\"credit_card_id\":1.100000023841858,\"currency\":\"\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_qy1mjazrhfld_readcharge() {
		String testResultId = "test_qy1mjazrhfld_readcharge";
	...
	@Test
	public void test_u82e3b4xagdg_readcharge() {
		String testResultId = "test_u82e3b4xagdg_readcharge";
	...
	@Test
	public void test_s1bni24mbhvd_readcharge() {
		String testResultId = "test_s1bni24mbhvd_readcharge";
	...
	@Test
	public void test_sok5vlmjbe43_readcharge() {
		String testResultId = "test_sok5vlmjbe43_readcharge";
	...
	@Test
	public void test_1iyhs6jhy8rp4_updatecharge() {
		String testResultId = "test_1iyhs6jhy8rp4_updatecharge";
	...
	@Test
	public void test_t4a1fayu3c6c_updatecharge() {
		String testResultId = "test_t4a1fayu3c6c_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "KS.H&xd~ci,yz`TS>siu")
				.contentType("application/json")
				.body("{\"amount\":null,\"credit_card_id\":1}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_rhb1nt6dp06x_updatecharge() {
		String testResultId = "test_rhb1nt6dp06x_updatecharge";
	...
	@Test
	public void test_1hrmi4oor1wds_updatecharge() {
		String testResultId = "test_1hrmi4oor1wds_updatecharge";
	...
	@Test
	public void test_1jics2iuy465u_deletecharge() {
		String testResultId = "test_1jics2iuy465u_deletecharge";
	...
	@Test
	public void test_1hvb0wx8m8odd_deletecharge() {
		String testResultId = "test_1hvb0wx8m8odd_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "?f`;YB&+8x)wa3WpQxa")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_qxficv37wh81_deletecharge() {
		String testResultId = "test_qxficv37wh81_deletecharge";
	...
	@Test
	public void test_1iupyru0io8j4_deletecharge() {
		String testResultId = "test_1iupyru0io8j4_deletecharge";
