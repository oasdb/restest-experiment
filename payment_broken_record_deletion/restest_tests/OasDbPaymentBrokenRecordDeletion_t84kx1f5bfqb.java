...
public class OasDbPaymentBrokenRecordDeletion_t84kx1f5bfqb {
	...
	private static final String testId = "t84kx1f5bfqb";
	...
	@Test
	public void test_vf0vi2kee8v6_createcharge() {
		String testResultId = "test_vf0vi2kee8v6_createcharge";
		...
		try {
			...
			.given()
				...
				.body("{\"amount\":1,\"credit_card_id\":1,\"currency\":\"randomString\"}")
				.filter(allureFilter)
	...
	@Test
	public void test_1hrjrizs2pqnp_createcharge() {
		String testResultId = "test_1hrjrizs2pqnp_createcharge";
	...
	@Test
	public void test_qxfg0ofyuici_createcharge() {
		String testResultId = "test_qxfg0ofyuici_createcharge";
	...
	@Test
	public void test_rl2dj2gaum3n_createcharge() {
		String testResultId = "test_rl2dj2gaum3n_createcharge";
	...
	@Test
	public void test_s18w1n1oclkk_readcharge() {
		String testResultId = "test_s18w1n1oclkk_readcharge";
	...
	@Test
	public void test_1jia1s56jz90j_readcharge() {
		String testResultId = "test_1jia1s56jz90j_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "T$ZR[G<b:T^J&PnU")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_t8427i6yegdd_readcharge() {
		String testResultId = "test_t8427i6yegdd_readcharge";
	...
	@Test
	public void test_r1a3eg4szv4y_readcharge() {
		String testResultId = "test_r1a3eg4szv4y_readcharge";
	...
	@Test
	public void test_qe1lt6pfty06_updatecharge() {
		String testResultId = "test_qe1lt6pfty06_updatecharge";
	...
	@Test
	public void test_1iyna3llub0hc_updatecharge() {
		String testResultId = "test_1iyna3llub0hc_updatecharge";
		...
		try {
			...
			.given()
				...
				.contentType("application/json")
				.body("{\"amount\":-2147483648,\"credit_card_id\":null}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1k1x8ntmpnnlh_updatecharge() {
		String testResultId = "test_1k1x8ntmpnnlh_updatecharge";
	...
	@Test
	public void test_1jy2o070937tt_updatecharge() {
		String testResultId = "test_1jy2o070937tt_updatecharge";
		...
		try {
			...
			.given()
				...
				.pathParam("charge_id", "18446744073709551616")
				.contentType("application/json")
				.body("{\"amount\":1,\"credit_card_id\":\"randomString\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_r1ivy5d8tsfp_deletecharge() {
		String testResultId = "test_r1ivy5d8tsfp_deletecharge";
	...
	@Test
	public void test_t8a58nd80u3q_deletecharge() {
		String testResultId = "test_t8a58nd80u3q_deletecharge";
	...
	@Test
	public void test_qhtd6zz7uhpv_deletecharge() {
		String testResultId = "test_qhtd6zz7uhpv_deletecharge";
	...
	@Test
	public void test_1iauxpoynd6wm_deletecharge() {
		String testResultId = "test_1iauxpoynd6wm_deletecharge";
