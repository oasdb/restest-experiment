...
public class OasDbPaymentBrokenRecordDeletion_1jyg19tfoyc6t {
	...
	private static final String testId = "1jyg19tfoyc6t";
	...
	@Test
	public void test_1iv3svaur865t_createcharge() {
		String testResultId = "test_1iv3svaur865t_createcharge";
	...
	@Test
	public void test_u7u1lgrn33oh_createcharge() {
		String testResultId = "test_u7u1lgrn33oh_createcharge";
		...
		try {
			...
			.given()
				.log().all()
				.contentType("application/json")
				.body("{\"amount\":1.100000023841858,\"credit_card_id\":-1,\"currency\":\"randomString\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1jidb63jjof8w_createcharge() {
		String testResultId = "test_1jidb63jjof8w_createcharge";
		...
		try {
			...
			.given()
				.log().all()
				.contentType("application/json")
				.body("{\"credit_card_id\":1.100000023841858,\"currency\":\"J#--ig9E|c9S%/X]V\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1iuy8zxbfgqi8_createcharge() {
		String testResultId = "test_1iuy8zxbfgqi8_createcharge";
	...
	@Test
	public void test_1jydszh1r2i5g_readcharge() {
		String testResultId = "test_1jydszh1r2i5g_readcharge";
	...
	@Test
	public void test_s1dwhq2a3uwm_readcharge() {
		String testResultId = "test_s1dwhq2a3uwm_readcharge";
	...
	@Test
	public void test_1ib0frzafvhb9_readcharge() {
		String testResultId = "test_1ib0frzafvhb9_readcharge";
	...
	@Test
	public void test_r1iv5uvz4it4_readcharge() {
		String testResultId = "test_r1iv5uvz4it4_readcharge";
	...
	@Test
	public void test_u7u3jge5u8va_updatecharge() {
		String testResultId = "test_u7u3jge5u8va_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "Z8@awH%5b.L")
				.contentType("application/json")
				.body("{\"amount\":-340282346638528860000000000000000000000000001,\"currency\":\"s\\\"hUkw~)6\\\\0\\\\fQ\\\\_^\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1ibbiszek6au9_updatecharge() {
		String testResultId = "test_1ibbiszek6au9_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "yz\\YM@KJN+Yps[MdmXd")
				.contentType("application/json")
	...
	@Test
	public void test_1jydaqg3gi52s_updatecharge() {
		String testResultId = "test_1jydaqg3gi52s_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "_s@N/+UEpDGY")
				.contentType("application/json")
	...
	@Test
	public void test_us09bvhizjvm_updatecharge() {
		String testResultId = "test_us09bvhizjvm_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "zM3Y\\<JhYicTW|GPc2l")
				.contentType("application/json")
	...
	@Test
	public void test_1iv9chhatlem1_deletecharge() {
		String testResultId = "test_1iv9chhatlem1_deletecharge";
	...
	@Test
	public void test_1jeoark6iic6t_deletecharge() {
		String testResultId = "test_1jeoark6iic6t_deletecharge";
	...
	@Test
	public void test_ubrdpodg8rhv_deletecharge() {
		String testResultId = "test_ubrdpodg8rhv_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "%p.C?(#b[MrXb")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_urp4ln2iz8za_deletecharge() {
		String testResultId = "test_urp4ln2iz8za_deletecharge";
