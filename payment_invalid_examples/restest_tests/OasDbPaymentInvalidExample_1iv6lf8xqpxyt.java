...
public class OasDbPaymentInvalidExample_1iv6lf8xqpxyt {
	...
	private static final String testId = "1iv6lf8xqpxyt";
	...
	@Test
	public void test_r1l4ju733dk2_createcharge() {
		String testResultId = "test_r1l4ju733dk2_createcharge";
		...
		try {
			...
			.given()
				...
				.body("{\"amount\":1.100000023841858,\"credit_card_id\":18446744073709551616,\"currency\":null}")
				.filter(allureFilter)
	...
	@Test
	public void test_sl668flh4njk_createcharge() {
		String testResultId = "test_sl668flh4njk_createcharge";
	...
	@Test
	public void test_urxxulj87jhe_createcharge() {
		String testResultId = "test_urxxulj87jhe_createcharge";
	...
	@Test
	public void test_rh4y8bgpkggx_createcharge() {
		String testResultId = "test_rh4y8bgpkggx_createcharge";
	...
	@Test
	public void test_1iv12nhjvm2wg_readcharge() {
		String testResultId = "test_1iv12nhjvm2wg_readcharge";
	...
	@Test
	public void test_somwskl5tzqs_readcharge() {
		String testResultId = "test_somwskl5tzqs_readcharge";
	...
	@Test
	public void test_t8cgnek3tlit_readcharge() {
		String testResultId = "test_t8cgnek3tlit_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "zXcF+rh_q7")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_t842z8mjb3u8_readcharge() {
		String testResultId = "test_t842z8mjb3u8_readcharge";
	...
	@Test
	public void test_vbmzdnjabbdx_updatecharge() {
		String testResultId = "test_vbmzdnjabbdx_updatecharge";
	...
	@Test
	public void test_1iuqfwv0q9q3m_updatecharge() {
		String testResultId = "test_1iuqfwv0q9q3m_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "dXR >lu7%O6=N")
				.contentType("application/json")
				.body("{\"amount\":18446744073709551616,\"currency\":\"randomString\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_rlb5jeuofu44_updatecharge() {
		String testResultId = "test_rlb5jeuofu44_updatecharge";
	...
	@Test
	public void test_u8ao8hhi4d9s_updatecharge() {
		String testResultId = "test_u8ao8hhi4d9s_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "OFJDqvT\\Kjlpo1HZ")
				.contentType("application/json")
				.body("{\"currency\":\"\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
	...
	@Test
	public void test_1iay6n7t0spwx_deletecharge() {
		String testResultId = "test_1iay6n7t0spwx_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "|yl9mh'=x+}ZVv")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_ts2elbsjznea_deletecharge() {
		String testResultId = "test_ts2elbsjznea_deletecharge";
	...
	@Test
	public void test_qhted2xoqdrk_deletecharge() {
		String testResultId = "test_qhted2xoqdrk_deletecharge";
	...
	@Test
	public void test_1hv897s3a4wgx_deletecharge() {
		String testResultId = "test_1hv897s3a4wgx_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "=2ImJjXha77Ew&WVI")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
