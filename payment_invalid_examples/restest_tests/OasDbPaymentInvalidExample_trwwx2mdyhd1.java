...
public class OasDbPaymentInvalidExample_trwwx2mdyhd1 {
	...
	private static final String testId = "trwwx2mdyhd1";
	...
	@Test
	public void test_1iupxacny5e8y_createcharge() {
		String testResultId = "test_1iupxacny5e8y_createcharge";
	...
	@Test
	public void test_t8cw8f192rty_createcharge() {
		String testResultId = "test_t8cw8f192rty_createcharge";
		...
		try {
			...
			.given()
				.log().all()
				.contentType("application/json")
				.body("{\"amount\":-1,\"credit_card_id\":0,\"currency\":\"one space\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1iauxbo97s27t_createcharge() {
		String testResultId = "test_1iauxbo97s27t_createcharge";
	...
	@Test
	public void test_vf1eoh4ipnja_createcharge() {
		String testResultId = "test_vf1eoh4ipnja_createcharge";
	...
	@Test
	public void test_1hv37x3bmp5cx_readcharge() {
		String testResultId = "test_1hv37x3bmp5cx_readcharge";
	...
	@Test
	public void test_1jym2r6084jso_readcharge() {
		String testResultId = "test_1jym2r6084jso_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "muC'`ZMU\"8U/")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1jy24udsxpu7s_readcharge() {
		String testResultId = "test_1jy24udsxpu7s_readcharge";
	...
	@Test
	public void test_rhlnabsrwgft_readcharge() {
		String testResultId = "test_rhlnabsrwgft_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "KQ|y>S!4FeBSKq9+")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_u8dzw1r8cnjp_updatecharge() {
		String testResultId = "test_u8dzw1r8cnjp_updatecharge";
	...
	@Test
	public void test_1h7u9k0vt1kjb_updatecharge() {
		String testResultId = "test_1h7u9k0vt1kjb_updatecharge";
	...
	@Test
	public void test_s4scynb85v8h_updatecharge() {
		String testResultId = "test_s4scynb85v8h_updatecharge";
	...
	@Test
	public void test_1ib988xk2fjua_updatecharge() {
		String testResultId = "test_1ib988xk2fjua_updatecharge";
	...
	@Test
	public void test_qxljd42np8bq_deletecharge() {
		String testResultId = "test_qxljd42np8bq_deletecharge";
	...
	@Test
	public void test_qhvozid6wmr7_deletecharge() {
		String testResultId = "test_qhvozid6wmr7_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "/Ws;>z&*?M/k?T)k")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1hvbjmchz4a5g_deletecharge() {
		String testResultId = "test_1hvbjmchz4a5g_deletecharge";
	...
	@Test
	public void test_sksv6c3vuich_deletecharge() {
		String testResultId = "test_sksv6c3vuich_deletecharge";
