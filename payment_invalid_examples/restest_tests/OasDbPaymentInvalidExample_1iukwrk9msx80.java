...
public class OasDbPaymentInvalidExample_1iukwrk9msx80 {
	...
	private static final String testId = "1iukwrk9msx80";
	...
	@Test
	public void test_1h7rhunu2m795_createcharge() {
		String testResultId = "test_1h7rhunu2m795_createcharge";
		...
		try {
			...
			.given()
				...
				.body("{\"amount\":18446744073709551616,\"credit_card_id\":\"\\\\0\"}")
				.filter(allureFilter)
	...
	@Test
	public void test_1jy4xuo7lx1dd_createcharge() {
		String testResultId = "test_1jy4xuo7lx1dd_createcharge";
	...
	@Test
	public void test_qeex72r7umw4_createcharge() {
		String testResultId = "test_qeex72r7umw4_createcharge";
	...
	@Test
	public void test_1hr84386tf969_createcharge() {
		String testResultId = "test_1hr84386tf969_createcharge";
	...
	@Test
	public void test_trwvti1imjw0_readcharge() {
		String testResultId = "test_trwvti1imjw0_readcharge";
	...
	@Test
	public void test_u7xcgyv7s3zt_readcharge() {
		String testResultId = "test_u7xcgyv7s3zt_readcharge";
	...
	@Test
	public void test_qe6krorwja77_readcharge() {
		String testResultId = "test_qe6krorwja77_readcharge";
	...
	@Test
	public void test_1jyoejckkk307_readcharge() {
		String testResultId = "test_1jyoejckkk307_readcharge";
	...
	@Test
	public void test_1jecowd4t5276_updatecharge() {
		String testResultId = "test_1jecowd4t5276_updatecharge";
	...
	@Test
	public void test_1if11wk945fld_updatecharge() {
		String testResultId = "test_1if11wk945fld_updatecharge";
	...
	@Test
	public void test_1jyjc5duojg3c_updatecharge() {
		String testResultId = "test_1jyjc5duojg3c_updatecharge";
	...
	@Test
	public void test_1iemoq2u6dq2a_updatecharge() {
		String testResultId = "test_1iemoq2u6dq2a_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "f.igcwE?K,&z1X[o@VvY")
				.contentType("application/json")
				.body("{\"amount\":18446744073709551616,\"currency\":null}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_u805hauztmwk_deletecharge() {
		String testResultId = "test_u805hauztmwk_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "a*Hz6>\\|3&p5>7iNN")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_skxug7uoenvm_deletecharge() {
		String testResultId = "test_skxug7uoenvm_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "Z,}<lW|cml[Fz")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1h7u9mplhjneg_deletecharge() {
		String testResultId = "test_1h7u9mplhjneg_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "O$H/DwNH[.vW9(a.U")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_qdy9rnavqv5e_deletecharge() {
		String testResultId = "test_qdy9rnavqv5e_deletecharge";
