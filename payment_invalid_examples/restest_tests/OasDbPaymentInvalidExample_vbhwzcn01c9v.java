...
public class OasDbPaymentInvalidExample_vbhwzcn01c9v {
	...
	private static final String testId = "vbhwzcn01c9v";
	...
	@Test
	public void test_skxx6ni6tfsp_createcharge() {
		String testResultId = "test_skxx6ni6tfsp_createcharge";
	...
	@Test
	public void test_urgutwh834mq_createcharge() {
		String testResultId = "test_urgutwh834mq_createcharge";
	...
	@Test
	public void test_vf478h4vfjvp_createcharge() {
		String testResultId = "test_vf478h4vfjvp_createcharge";
	...
	@Test
	public void test_qhhtevov5pvb_createcharge() {
		String testResultId = "test_qhhtevov5pvb_createcharge";
	...
	@Test
	public void test_1ibjsyhl5edde_readcharge() {
		String testResultId = "test_1ibjsyhl5edde_readcharge";
	...
	@Test
	public void test_r1fmy1udafxt_readcharge() {
		String testResultId = "test_r1fmy1udafxt_readcharge";
	...
	@Test
	public void test_t4neaw8ozsxd_readcharge() {
		String testResultId = "test_t4neaw8ozsxd_readcharge";
	...
	@Test
	public void test_vbq9gvijf50w_readcharge() {
		String testResultId = "test_vbq9gvijf50w_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "5T4-qlfYQ)\"4XY1")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1hv5g9oo07eid_updatecharge() {
		String testResultId = "test_1hv5g9oo07eid_updatecharge";
	...
	@Test
	public void test_tnyztw6vrtis_updatecharge() {
		String testResultId = "test_tnyztw6vrtis_updatecharge";
		...
		try {
			...
			.given()
				...
				.pathParam("charge_id", "-2147483648")
				.contentType("application/json")
				.body("{\"amount\":4294967296,\"credit_card_id\":1.100000023841858,\"currency\":\"randomString\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1ib0wupd3if5l_updatecharge() {
		String testResultId = "test_1ib0wupd3if5l_updatecharge";
		...
		try {
			...
			.given()
				...
				.pathParam("charge_id", "\\0")
				.contentType("application/json")
				.body("{\"amount\":-2147483648,\"currency\":null}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_t4kndl3csl0i_updatecharge() {
		String testResultId = "test_t4kndl3csl0i_updatecharge";
		...
		try {
			...
			.given()
				...
				.contentType("application/json")
				.body("{\"amount\":-1,\"currency\":\"bV36mWHC<~cw|e\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1ieyazmurmc12_deletecharge() {
		String testResultId = "test_1ieyazmurmc12_deletecharge";
	...
	@Test
	public void test_to7u93khd10l_deletecharge() {
		String testResultId = "test_to7u93khd10l_deletecharge";
	...
	@Test
	public void test_1ji9z4lr77kfq_deletecharge() {
		String testResultId = "test_1ji9z4lr77kfq_deletecharge";
	...
	@Test
	public void test_1ievj569nps8i_deletecharge() {
		String testResultId = "test_1ievj569nps8i_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "oW+,Q= h]:_1D~")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
