...
public class OasDbPaymentInvalidExample_qdsrdj6u4ab6 {
	...
	private static final String testId = "qdsrdj6u4ab6";
	...
	@Test
	public void test_s10230qx1ht0_createcharge() {
		String testResultId = "test_s10230qx1ht0_createcharge";
	...
	@Test
	public void test_1jy25anuu0a49_createcharge() {
		String testResultId = "test_1jy25anuu0a49_createcharge";
	...
	@Test
	public void test_r1ajrr0zut69_createcharge() {
		String testResultId = "test_r1ajrr0zut69_createcharge";
	...
	@Test
	public void test_qxi99vp7lw81_createcharge() {
		String testResultId = "test_qxi99vp7lw81_createcharge";
		...
		try {
			...
			.given()
				.log().all()
				.contentType("application/json")
				.body("{\"amount\":-1,\"currency\":\"randomString\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_t4f3d7x417ow_readcharge() {
		String testResultId = "test_t4f3d7x417ow_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "5o\"yqs[flh-qEH+#?axH")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_s18wi8vzmxcy_readcharge() {
		String testResultId = "test_s18wi8vzmxcy_readcharge";
	...
	@Test
	public void test_1iyq3fnuu9zkz_readcharge() {
		String testResultId = "test_1iyq3fnuu9zkz_readcharge";
	...
	@Test
	public void test_sl8ybznhm9ti_readcharge() {
		String testResultId = "test_sl8ybznhm9ti_readcharge";
	...
	@Test
	public void test_1ibbif0bcgmyh_updatecharge() {
		String testResultId = "test_1ibbif0bcgmyh_updatecharge";
	...
	@Test
	public void test_1jy7rysndo7jt_updatecharge() {
		String testResultId = "test_1jy7rysndo7jt_updatecharge";
	...
	@Test
	public void test_qe9ef8zipkqb_updatecharge() {
		String testResultId = "test_qe9ef8zipkqb_updatecharge";
	...
	@Test
	public void test_qdqgrfy9zhpf_updatecharge() {
		String testResultId = "test_qdqgrfy9zhpf_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "BzT@tJL<Pse69).d)h")
				.contentType("application/json")
	...
	@Test
	public void test_vey5aeqiuoo3_deletecharge() {
		String testResultId = "test_vey5aeqiuoo3_deletecharge";
	...
	@Test
	public void test_vevb8zcv1fso_deletecharge() {
		String testResultId = "test_vevb8zcv1fso_deletecharge";
	...
	@Test
	public void test_sonf44paue01_deletecharge() {
		String testResultId = "test_sonf44paue01_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "Cr.@:[&7RWH4 Qv(,Q^")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1hbd656aaqijo_deletecharge() {
		String testResultId = "test_1hbd656aaqijo_deletecharge";
