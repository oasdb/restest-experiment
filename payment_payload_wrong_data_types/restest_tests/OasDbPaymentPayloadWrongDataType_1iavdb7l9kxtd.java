...
public class OasDbPaymentPayloadWrongDataType_1iavdb7l9kxtd {
	...
	private static final String testId = "1iavdb7l9kxtd";
	...
	@Test
	public void test_t843rh2rzk2p_createcharge() {
		String testResultId = "test_t843rh2rzk2p_createcharge";
		...
		try {
			...
			.given()
				...
				.body("{\"amount\":0,\"credit_card_id\":\"randomString\",\"currency\":\"8bf<| <B5?G/Mh\"}")
				.filter(allureFilter)
	...
	@Test
	public void test_vbhwkvqw7pdi_createcharge() {
		String testResultId = "test_vbhwkvqw7pdi_createcharge";
		...
		try {
			...
			.given()
				.log().all()
				.contentType("application/json")
				.body("{\"amount\":-9223372036854775808,\"credit_card_id\":-1,\"currency\":\"\\\\0\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1jeo9lh83fjae_createcharge() {
		String testResultId = "test_1jeo9lh83fjae_createcharge";
	...
	@Test
	public void test_r17bay0pl54g_createcharge() {
		String testResultId = "test_r17bay0pl54g_createcharge";
	...
	@Test
	public void test_trzooys336n7_readcharge() {
		String testResultId = "test_trzooys336n7_readcharge";
	...
	@Test
	public void test_sof3v3w3jr6p_readcharge() {
		String testResultId = "test_sof3v3w3jr6p_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "!>-CGq;_wc%dG6o")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1hbaed4voyrzo_readcharge() {
		String testResultId = "test_1hbaed4voyrzo_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "!yZN=\\U&JgPb")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_rhtw75w0p1eu_readcharge() {
		String testResultId = "test_rhtw75w0p1eu_readcharge";
	...
	@Test
	public void test_rhdbw18o9zdv_updatecharge() {
		String testResultId = "test_rhdbw18o9zdv_updatecharge";
	...
	@Test
	public void test_vf47jxidjhgy_updatecharge() {
		String testResultId = "test_vf47jxidjhgy_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "^:n0SFZ:tD$'F6C")
				.contentType("application/json")
	...
	@Test
	public void test_toa4hjiw9ysh_updatecharge() {
		String testResultId = "test_toa4hjiw9ysh_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "]I3~M?X@5#C|SM_YUm-P")
				.contentType("application/json")
				.body("{\"credit_card_id\":2147483648,\"currency\":\"randomString\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1iyexluu6shme_updatecharge() {
		String testResultId = "test_1iyexluu6shme_updatecharge";
		...
		try {
			...
			.given()
				...
				.contentType("application/json")
				.body("{\"amount\":-.000001,\"credit_card_id\":null,\"currency\":null}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_t4l58jan0gmo_deletecharge() {
		String testResultId = "test_t4l58jan0gmo_deletecharge";
	...
	@Test
	public void test_1hbfz5qj0hch1_deletecharge() {
		String testResultId = "test_1hbfz5qj0hch1_deletecharge";
	...
	@Test
	public void test_uvjo5mr16jp1_deletecharge() {
		String testResultId = "test_uvjo5mr16jp1_deletecharge";
	...
	@Test
	public void test_tonzr41yr7ty_deletecharge() {
		String testResultId = "test_tonzr41yr7ty_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "v|@i\"q \"C OQkY")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
