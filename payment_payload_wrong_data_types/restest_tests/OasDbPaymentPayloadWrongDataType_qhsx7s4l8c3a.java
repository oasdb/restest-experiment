...
public class OasDbPaymentPayloadWrongDataType_qhsx7s4l8c3a {
	...
	private static final String testId = "qhsx7s4l8c3a";
	...
	@Test
	public void test_1jelgz5zd2fxs_createcharge() {
		String testResultId = "test_1jelgz5zd2fxs_createcharge";
	...
	@Test
	public void test_1iun704ijeqm0_createcharge() {
		String testResultId = "test_1iun704ijeqm0_createcharge";
	...
	@Test
	public void test_1jy5hcb92g5yt_createcharge() {
		String testResultId = "test_1jy5hcb92g5yt_createcharge";
	...
	@Test
	public void test_s50pdrdwf7fq_createcharge() {
		String testResultId = "test_s50pdrdwf7fq_createcharge";
	...
	@Test
	public void test_s1dw3z6s6qlw_readcharge() {
		String testResultId = "test_s1dw3z6s6qlw_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "9C2JcT*Nw5")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_skvl0211nuwk_readcharge() {
		String testResultId = "test_skvl0211nuwk_readcharge";
	...
	@Test
	public void test_trtna8me3hvd_readcharge() {
		String testResultId = "test_trtna8me3hvd_readcharge";
	...
	@Test
	public void test_tolqanzt6q90_readcharge() {
		String testResultId = "test_tolqanzt6q90_readcharge";
	...
	@Test
	public void test_1ibeto3q8x1kh_updatecharge() {
		String testResultId = "test_1ibeto3q8x1kh_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "_0k;6:Lucc2WLR?,n;ry")
				.contentType("application/json")
				.body("{\"amount\":null,\"currency\":\"one space\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_rhiwm0irisdt_updatecharge() {
		String testResultId = "test_rhiwm0irisdt_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "4ZO<j=x1|(|Q8sc")
				.contentType("application/json")
	...
	@Test
	public void test_vf1fgbszkq5g_updatecharge() {
		String testResultId = "test_vf1fgbszkq5g_updatecharge";
	...
	@Test
	public void test_t8cfv2uefvhy_updatecharge() {
		String testResultId = "test_t8cfv2uefvhy_updatecharge";
		...
		try {
			...
			.given()
				...
				.contentType("application/json")
				.body("{\"amount\":\"\",\"currency\":\"randomString\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1if11lbdul5ps_deletecharge() {
		String testResultId = "test_1if11lbdul5ps_deletecharge";
	...
	@Test
	public void test_urxf54ctxeep_deletecharge() {
		String testResultId = "test_urxf54ctxeep_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "WGP2;`!Z\\ @0->Tdb@l")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_vb6dl1wx15bp_deletecharge() {
		String testResultId = "test_vb6dl1wx15bp_deletecharge";
	...
	@Test
	public void test_t844jhcokjlh_deletecharge() {
		String testResultId = "test_t844jhcokjlh_deletecharge";
