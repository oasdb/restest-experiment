...
public class OasDbPaymentPayloadWrongDataType_1hb87phbd5eg5 {
	...
	private static final String testId = "1hb87phbd5eg5";
	...
	@Test
	public void test_rhdca4bc2lh2_createcharge() {
		String testResultId = "test_rhdca4bc2lh2_createcharge";
		...
		try {
			...
			.given()
				...
				.body("{\"currency\":\"T^-8iQ+8,mz>195>]F]z\"}")
				.filter(allureFilter)
	...
	@Test
	public void test_soccsk0j7aea_createcharge() {
		String testResultId = "test_soccsk0j7aea_createcharge";
		...
		try {
			...
			.given()
				.log().all()
				.contentType("application/json")
				.body("{\"amount\":2147483648,\"credit_card_id\":18446744073709551616}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1iusprtknoehu_createcharge() {
		String testResultId = "test_1iusprtknoehu_createcharge";
	...
	@Test
	public void test_s1jxywolwqxx_createcharge() {
		String testResultId = "test_s1jxywolwqxx_createcharge";
	...
	@Test
	public void test_rkzlawmwvub7_readcharge() {
		String testResultId = "test_rkzlawmwvub7_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "f_ytri~N, ]V&")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_toloo35d2jxd_readcharge() {
		String testResultId = "test_toloo35d2jxd_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "aU;BcPtl8jp")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1iv73q9lw6ek7_readcharge() {
		String testResultId = "test_1iv73q9lw6ek7_readcharge";
	...
	@Test
	public void test_1jefg9s1ks3e9_readcharge() {
		String testResultId = "test_1jefg9s1ks3e9_readcharge";
	...
	@Test
	public void test_qhhqlva2irlc_updatecharge() {
		String testResultId = "test_qhhqlva2irlc_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "34m_/3z<X[6o,.3d[g")
				.contentType("application/json")
	...
	@Test
	public void test_1jia1s75lacmc_updatecharge() {
		String testResultId = "test_1jia1s75lacmc_updatecharge";
	...
	@Test
	public void test_1iavf9ep5fbxy_updatecharge() {
		String testResultId = "test_1iavf9ep5fbxy_updatecharge";
	...
	@Test
	public void test_qdvj5x39fvaw_updatecharge() {
		String testResultId = "test_qdvj5x39fvaw_updatecharge";
	...
	@Test
	public void test_1h7lf4t5g38ti_deletecharge() {
		String testResultId = "test_1h7lf4t5g38ti_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "c(&Y'Wx%h*[y\\SdpI31")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1jeyvhgdxny2d_deletecharge() {
		String testResultId = "test_1jeyvhgdxny2d_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "a4m@4=zwL6Q1t/y@2kG")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_s0v16bveabms_deletecharge() {
		String testResultId = "test_s0v16bveabms_deletecharge";
	...
	@Test
	public void test_1h84t5wfmj039_deletecharge() {
		String testResultId = "test_1h84t5wfmj039_deletecharge";
