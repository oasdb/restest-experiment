...
public class OasDbPaymentUnexpectedPayloadRootNode_ubre39ou9bua {
	...
	private static final String testId = "ubre39ou9bua";
	...
	@Test
	public void test_qhncw6iccai8_createcharge() {
		String testResultId = "test_qhncw6iccai8_createcharge";
	...
	@Test
	public void test_uv8mosmw35f9_createcharge() {
		String testResultId = "test_uv8mosmw35f9_createcharge";
	...
	@Test
	public void test_1h7lgp53ee6uo_createcharge() {
		String testResultId = "test_1h7lgp53ee6uo_createcharge";
	...
	@Test
	public void test_1k1rqa0zj4xgl_createcharge() {
		String testResultId = "test_1k1rqa0zj4xgl_createcharge";
		...
		try {
			...
			.given()
				.log().all()
				.contentType("application/json")
				.body("{\"amount\":\"randomString\",\"currency\":\"\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_ubj5vworwfvp_readcharge() {
		String testResultId = "test_ubj5vworwfvp_readcharge";
	...
	@Test
	public void test_1hrbf13gbaxis_readcharge() {
		String testResultId = "test_1hrbf13gbaxis_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "QGl7v:9'fMD6a6")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1hbah3e86nghf_readcharge() {
		String testResultId = "test_1hbah3e86nghf_readcharge";
	...
	@Test
	public void test_qxl27z65d0s4_readcharge() {
		String testResultId = "test_qxl27z65d0s4_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "2fY;Fz)9yj")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_veym24m3uey9_updatecharge() {
		String testResultId = "test_veym24m3uey9_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "eHH@uvH4<'3M$")
				.contentType("application/json")
				.body("{\"amount\":\"randomString\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
	...
	@Test
	public void test_us0r6juzsrht_updatecharge() {
		String testResultId = "test_us0r6juzsrht_updatecharge";
	...
	@Test
	public void test_qxob7s54qnac_updatecharge() {
		String testResultId = "test_qxob7s54qnac_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", ">ZPm+%;QEpkQ5C5-")
				.contentType("application/json")
	...
	@Test
	public void test_1h7lfzfq4slkl_updatecharge() {
		String testResultId = "test_1h7lfzfq4slkl_updatecharge";
	...
	@Test
	public void test_1iykipnb6uhbl_deletecharge() {
		String testResultId = "test_1iykipnb6uhbl_deletecharge";
	...
	@Test
	public void test_qhw4yzpnnyht_deletecharge() {
		String testResultId = "test_qhw4yzpnnyht_deletecharge";
	...
	@Test
	public void test_t4km79untso4_deletecharge() {
		String testResultId = "test_t4km79untso4_deletecharge";
	...
	@Test
	public void test_1hv37zcljr4mt_deletecharge() {
		String testResultId = "test_1hv37zcljr4mt_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "~WtO%) a^1^dp]")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
