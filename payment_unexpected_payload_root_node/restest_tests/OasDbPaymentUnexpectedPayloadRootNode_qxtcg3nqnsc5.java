...
public class OasDbPaymentUnexpectedPayloadRootNode_qxtcg3nqnsc5 {
	...
	private static final String testId = "qxtcg3nqnsc5";
	...
	@Test
	public void test_us3i906pdftu_createcharge() {
		String testResultId = "test_us3i906pdftu_createcharge";
	...
	@Test
	public void test_ubrx6tyyi5h4_createcharge() {
		String testResultId = "test_ubrx6tyyi5h4_createcharge";
	...
	@Test
	public void test_1ib0g61yyhid4_createcharge() {
		String testResultId = "test_1ib0g61yyhid4_createcharge";
	...
	@Test
	public void test_rhm4d9qfshtc_createcharge() {
		String testResultId = "test_rhm4d9qfshtc_createcharge";
	...
	@Test
	public void test_t4huctbk11yo_readcharge() {
		String testResultId = "test_t4huctbk11yo_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "]+}msD%|u]He 0")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1jyovb02548xc_readcharge() {
		String testResultId = "test_1jyovb02548xc_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "cl/kf/we>[d,EoQ")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1iaxnm7xdb60j_readcharge() {
		String testResultId = "test_1iaxnm7xdb60j_readcharge";
	...
	@Test
	public void test_1ji1r8nj977fm_readcharge() {
		String testResultId = "test_1ji1r8nj977fm_readcharge";
	...
	@Test
	public void test_1if12rh29lyyd_updatecharge() {
		String testResultId = "test_1if12rh29lyyd_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "H?up7RE7.8nbNVl'Ou")
				.contentType("application/json")
				.body("{\"currency\":\"d9X6sa//t4Tb1\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_vbkp53mr9nqa_updatecharge() {
		String testResultId = "test_vbkp53mr9nqa_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "YUrnw[}.@[1o|I:@4D%j")
				.contentType("application/json")
				.body("{\"amount\":\"W18=`a$Ar%KsfC=\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1hv39gvz1g02u_updatecharge() {
		String testResultId = "test_1hv39gvz1g02u_updatecharge";
	...
	@Test
	public void test_1jefh4gmqcajp_updatecharge() {
		String testResultId = "test_1jefh4gmqcajp_updatecharge";
	...
	@Test
	public void test_1jed77d2a1rvl_deletecharge() {
		String testResultId = "test_1jed77d2a1rvl_deletecharge";
	...
	@Test
	public void test_s1jf9t9hi34x_deletecharge() {
		String testResultId = "test_s1jf9t9hi34x_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "SsZA3X2;@Le?bBEp)j%L")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1jydr0zmwdr20_deletecharge() {
		String testResultId = "test_1jydr0zmwdr20_deletecharge";
	...
	@Test
	public void test_t4telppkm62f_deletecharge() {
		String testResultId = "test_t4telppkm62f_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "$.Tm(`_L^p8]SH")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
