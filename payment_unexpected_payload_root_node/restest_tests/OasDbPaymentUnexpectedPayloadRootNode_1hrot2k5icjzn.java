...
public class OasDbPaymentUnexpectedPayloadRootNode_1hrot2k5icjzn {
	...
	private static final String testId = "1hrot2k5icjzn";
	...
	@Test
	public void test_uv5w2yjpcg8m_createcharge() {
		String testResultId = "test_uv5w2yjpcg8m_createcharge";
	...
	@Test
	public void test_1iycpptsomvl2_createcharge() {
		String testResultId = "test_1iycpptsomvl2_createcharge";
		...
		try {
			...
			.given()
				.log().all()
				.contentType("application/json")
				.body("{\"credit_card_id\":\"WD.O1^BY\\\\vGW/q9 DLuO\",\"currency\":\"\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_to52vestk94h_createcharge() {
		String testResultId = "test_to52vestk94h_createcharge";
	...
	@Test
	public void test_1iepfe7smass1_createcharge() {
		String testResultId = "test_1iepfe7smass1_createcharge";
	...
	@Test
	public void test_vbszdctno4s2_readcharge() {
		String testResultId = "test_vbszdctno4s2_readcharge";
	...
	@Test
	public void test_urp6jgq8hxsz_readcharge() {
		String testResultId = "test_urp6jgq8hxsz_readcharge";
	...
	@Test
	public void test_1ibe93fuabigo_readcharge() {
		String testResultId = "test_1ibe93fuabigo_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", ",T8Z%M]iEB.mcS++-2")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_uve5dvpltgz4_readcharge() {
		String testResultId = "test_uve5dvpltgz4_readcharge";
	...
	@Test
	public void test_trz5o377s9k3_updatecharge() {
		String testResultId = "test_trz5o377s9k3_updatecharge";
	...
	@Test
	public void test_soq6i5bz63hx_updatecharge() {
		String testResultId = "test_soq6i5bz63hx_updatecharge";
	...
	@Test
	public void test_1hv89j08wtrn9_updatecharge() {
		String testResultId = "test_1hv89j08wtrn9_updatecharge";
	...
	@Test
	public void test_sksv8mn0tnp5_updatecharge() {
		String testResultId = "test_sksv8mn0tnp5_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "aLPBT[^shDa:V5u&gS")
				.contentType("application/json")
	...
	@Test
	public void test_ubj3mip9jsxd_deletecharge() {
		String testResultId = "test_ubj3mip9jsxd_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "xfDu%(W\"qc7e,rm")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_s4rth3hzcp5v_deletecharge() {
		String testResultId = "test_s4rth3hzcp5v_deletecharge";
	...
	@Test
	public void test_1iuvgdckungoh_deletecharge() {
		String testResultId = "test_1iuvgdckungoh_deletecharge";
	...
	@Test
	public void test_s0xamp7uaxcx_deletecharge() {
		String testResultId = "test_s0xamp7uaxcx_deletecharge";
