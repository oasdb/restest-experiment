...
public class OasDbPaymentUnexpectedPayloadRootNode_t4vqgwh8v9yr {
	...
	private static final String testId = "t4vqgwh8v9yr";
	...
	@Test
	public void test_1h82khix9s50l_createcharge() {
		String testResultId = "test_1h82khix9s50l_createcharge";
	...
	@Test
	public void test_1huxp7p5f7eia_createcharge() {
		String testResultId = "test_1huxp7p5f7eia_createcharge";
	...
	@Test
	public void test_1jei84g5hpzck_createcharge() {
		String testResultId = "test_1jei84g5hpzck_createcharge";
	...
	@Test
	public void test_urhctzspfv52_createcharge() {
		String testResultId = "test_urhctzspfv52_createcharge";
	...
	@Test
	public void test_skxwgw6i2uyc_readcharge() {
		String testResultId = "test_skxwgw6i2uyc_readcharge";
	...
	@Test
	public void test_vbq8ox9dmrlc_readcharge() {
		String testResultId = "test_vbq8ox9dmrlc_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "*R;2~l8=Gg8bysc:3&ra")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_qy4dzmhsc1gk_readcharge() {
		String testResultId = "test_qy4dzmhsc1gk_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "wk+}Ovte7DG\"\\k'F")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1h7whj0v4sg8o_readcharge() {
		String testResultId = "test_1h7whj0v4sg8o_readcharge";
	...
	@Test
	public void test_1hr843a3y7qsi_updatecharge() {
		String testResultId = "test_1hr843a3y7qsi_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "gu\"2,3Lhcqt.i")
				.contentType("application/json")
				.body("{\"amount\":2147483648,\"credit_card_id\":2147483648,\"currency\":\"\\\\0\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1hv8b34ng4sbq_updatecharge() {
		String testResultId = "test_1hv8b34ng4sbq_updatecharge";
	...
	@Test
	public void test_rh893lbwffp3_updatecharge() {
		String testResultId = "test_rh893lbwffp3_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "e8J|=PSF_lA5Q)3D4TU")
				.contentType("application/json")
				.body("{}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
	...
	@Test
	public void test_sl3xhgy8e9uu_updatecharge() {
		String testResultId = "test_sl3xhgy8e9uu_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "pTYL.ts=jqwq/7[X:")
				.contentType("application/json")
				.body("{\"amount\":\"randomString\",\"currency\":\"\\\\0\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_ubu8lev3lsmo_deletecharge() {
		String testResultId = "test_ubu8lev3lsmo_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "G)b D8JHgK#")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_rl2dge3fw95v_deletecharge() {
		String testResultId = "test_rl2dge3fw95v_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "/F;]=TR/+ro^,Bl_N@4")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_s4mcyw1hyicl_deletecharge() {
		String testResultId = "test_s4mcyw1hyicl_deletecharge";
	...
	@Test
	public void test_to1srwxjlkrm_deletecharge() {
		String testResultId = "test_to1srwxjlkrm_deletecharge";
