...
public class OasDbPaymentUnexpectedPayloadRootNode_r1dbxg1zlh7m {
	...
	private static final String testId = "r1dbxg1zlh7m";
	...
	@Test
	public void test_skv50qn09v00_createcharge() {
		String testResultId = "test_skv50qn09v00_createcharge";
	...
	@Test
	public void test_1h7inqu3dmcf7_createcharge() {
		String testResultId = "test_1h7inqu3dmcf7_createcharge";
	...
	@Test
	public void test_rkwsqulvb1vb_createcharge() {
		String testResultId = "test_rkwsqulvb1vb_createcharge";
		...
		try {
			...
			.given()
				.log().all()
				.contentType("application/json")
				.body("{\"amount\":18446744073709551616,\"currency\":\"?wTWfM&3R*\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_urk2z4uvvui9_createcharge() {
		String testResultId = "test_urk2z4uvvui9_createcharge";
	...
	@Test
	public void test_t84mgvz1hf1i_readcharge() {
		String testResultId = "test_t84mgvz1hf1i_readcharge";
	...
	@Test
	public void test_1hbd7dspxlph4_readcharge() {
		String testResultId = "test_1hbd7dspxlph4_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "W.S)dqO2hhc;[s?GY\\")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_s4pmanjfc56g_readcharge() {
		String testResultId = "test_s4pmanjfc56g_readcharge";
	...
	@Test
	public void test_tol92qtpjbxw_readcharge() {
		String testResultId = "test_tol92qtpjbxw_readcharge";
	...
	@Test
	public void test_1hrp9idhing4j_updatecharge() {
		String testResultId = "test_1hrp9idhing4j_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "dq+Vn;*X<coeB=")
				.contentType("application/json")
				.body("{\"amount\":0}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
	...
	@Test
	public void test_1ji9ziou516xt_updatecharge() {
		String testResultId = "test_1ji9ziou516xt_updatecharge";
	...
	@Test
	public void test_vbhec8m1a2b6_updatecharge() {
		String testResultId = "test_vbhec8m1a2b6_updatecharge";
	...
	@Test
	public void test_sl9fv9l523at_updatecharge() {
		String testResultId = "test_sl9fv9l523at_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "?n_\\z05&^!'D\"zE'2")
				.contentType("application/json")
				.body("{}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
	...
	@Test
	public void test_vey62gykej51_deletecharge() {
		String testResultId = "test_vey62gykej51_deletecharge";
	...
	@Test
	public void test_1k1r76j1rkxm8_deletecharge() {
		String testResultId = "test_1k1r76j1rkxm8_deletecharge";
	...
	@Test
	public void test_rh50yf9feu5x_deletecharge() {
		String testResultId = "test_rh50yf9feu5x_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "s)4Yw:Wx'vs?5")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_1h7x0xxkfc50i_deletecharge() {
		String testResultId = "test_1h7x0xxkfc50i_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "\\|p}JX_J=m0V`)o")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
