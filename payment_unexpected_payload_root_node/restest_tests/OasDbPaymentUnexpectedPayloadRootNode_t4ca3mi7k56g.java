...
public class OasDbPaymentUnexpectedPayloadRootNode_t4ca3mi7k56g {
	...
	private static final String testId = "t4ca3mi7k56g";
	...
	@Test
	public void test_1iync1vg65mig_createcharge() {
		String testResultId = "test_1iync1vg65mig_createcharge";
	...
	@Test
	public void test_vf6yxo8q9t9e_createcharge() {
		String testResultId = "test_vf6yxo8q9t9e_createcharge";
		...
		try {
			...
			.given()
				.log().all()
				.contentType("application/json")
				.body("{\"amount\":340282346638528860000000000000000000000.000001,\"credit_card_id\":0,\"currency\":\"\\\\0\"}")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_toixcmvjtruh_createcharge() {
		String testResultId = "test_toixcmvjtruh_createcharge";
	...
	@Test
	public void test_t4qmtxtda1wy_createcharge() {
		String testResultId = "test_t4qmtxtda1wy_createcharge";
	...
	@Test
	public void test_sok32l9cr29h_readcharge() {
		String testResultId = "test_sok32l9cr29h_readcharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "zCr:TuGP['4~E/'O")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
	...
	@Test
	public void test_skjz6xya7tbs_readcharge() {
		String testResultId = "test_skjz6xya7tbs_readcharge";
	...
	@Test
	public void test_sl3xhhbvsm01_readcharge() {
		String testResultId = "test_sl3xhhbvsm01_readcharge";
	...
	@Test
	public void test_r1g4y5ia83ec_readcharge() {
		String testResultId = "test_r1g4y5ia83ec_readcharge";
	...
	@Test
	public void test_1hrosr9cpklrt_updatecharge() {
		String testResultId = "test_1hrosr9cpklrt_updatecharge";
	...
	@Test
	public void test_1hb7pboe008rl_updatecharge() {
		String testResultId = "test_1hb7pboe008rl_updatecharge";
	...
	@Test
	public void test_u8dhywzf1fso_updatecharge() {
		String testResultId = "test_u8dhywzf1fso_updatecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "ykLp%M|HOq<6; bOi_")
				.contentType("application/json")
	...
	@Test
	public void test_r1ieej9p7bz5_updatecharge() {
		String testResultId = "test_r1ieej9p7bz5_updatecharge";
	...
	@Test
	public void test_vbk59j3klgf5_deletecharge() {
		String testResultId = "test_vbk59j3klgf5_deletecharge";
	...
	@Test
	public void test_toa3bi7ck305_deletecharge() {
		String testResultId = "test_toa3bi7ck305_deletecharge";
	...
	@Test
	public void test_qxqjtja7i6nt_deletecharge() {
		String testResultId = "test_qxqjtja7i6nt_deletecharge";
	...
	@Test
	public void test_t4c9bpupqvs6_deletecharge() {
		String testResultId = "test_t4c9bpupqvs6_deletecharge";
		...
		try {
			...
			.given()
				.log().all()
				.pathParam("charge_id", "_v1F]UW&ux.")
				.filter(allureFilter)
				.filter(statusCode5XXFilter)
				.filter(nominalOrFaultyTestCaseFilter)
				.filter(validationFilter)
